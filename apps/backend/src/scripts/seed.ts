...
const sportsArticles = [
  {
    ...
    content:
      'Real Madrid secured a 3–1 victory in a dominant Champions League final performance...',
  ...
  },
  {
    ...
    content:
      'India secured the T20 series after a stellar all-round performance in the final match...',
  ...
  },
  {
    ...
    content:
      'A veteran legend advanced to yet another championship final after a tense semifinal...',
    createdAt: new Date('2024-05-17'),
  ...
  },
  {
    ...
    content:
      'China continued its dominance by sweeping the team competitions at the World Championships...',
